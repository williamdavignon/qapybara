...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = QAZ(
        ...
        KC_A,    KC_S,    LALT_T(KC_D),    LGUI_T(KC_F)	,    KC_G,    KC_H,    RGUI_T(KC_J),    LALT_T(KC_K),    KC_L,    KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    LSFT_T(KC_V),    RSFT_T(KC_B),    KC_N,    KC_M,    KC_COMM ,    LT(KC_RSFT, KC_DOT),
        MO(1), KC_LGUI, LT(2, KC_SPC),  MO(3),    KC_LALT
    ),
    [1] = QAZ(
